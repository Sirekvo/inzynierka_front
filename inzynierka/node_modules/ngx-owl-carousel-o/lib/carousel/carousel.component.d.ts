...
export declare class CarouselSlideDirective {
    ...
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<CarouselSlideDirective, "ng-template[carouselSlide]", never, { "id": "id"; "width": "width"; "dotContent": "dotContent"; "dataHash": "dataHash"; "dataMerge": "dataMerge"; }, {}, never, never, false>;
}
/**
...
export declare class CarouselComponent implements OnInit, AfterContentChecked, AfterContentInit, OnDestroy {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<CarouselComponent, "owl-carousel-o", never, { "options": "options"; }, { "translated": "translated"; "dragging": "dragging"; "change": "change"; "changed": "changed"; "initialized": "initialized"; }, ["slides"], never, false>;
}
